...
| [openclaw-a2a-gateway](https://github.com/win4r/openclaw-a2a-gateway) | OpenClaw A2A v0.3.0 协议插件——仿生路由、mDNS 发现、熔断器、DevTools CLI，486 个测试 |
...
| [ClawTeam-OpenClaw](https://github.com/win4r/ClawTeam-OpenClaw) | Python | OpenClaw 原生多 Agent 编排框架——意图驱动 Prompt、Boids 涌现协作、熔断器、成本仪表板、逐 Agent 模型分配 |
